...
from clases.validaciones import pedir_cedula, pedir_serial, pedir_opcion_menu, confirmar_accion
...
def devolver_equipo_ingeniero():
    ...
    if not confirmar_accion("¿Desea devolver el equipo?"):
